...
def generate_launch_description():
    input_cmd_arg = DeclareLaunchArgument("input_cmd_topic", default_value="/cmd_vel_raw")
    output_cmd_arg = DeclareLaunchArgument("output_cmd_topic", default_value="/cmd_vel")
