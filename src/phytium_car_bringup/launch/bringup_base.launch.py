...
def generate_launch_description():
    ...
    d6_lidar_node = Node(
        ...
        parameters=[{
            ...
            # 给 LaserScan 时间戳轻微回退，避免 slam_toolbox 按 scan_time 查 TF 时外推失败
            'scan_time_offset_sec': 1.50,
        }]
    )
    ...
    cmd_vel_mux_node = Node(
        ...
        parameters=[{
            ...
            #   /cmd_vel_web     Web手动控制
            #   /cmd_vel_nav     导航控制
            #   /cmd_vel_follow  视觉跟随控制
            # 输出：
            #   /cmd_vel_raw     给 safety_guard
        }]
    )
    ...
    safety_guard_node = Node(
        ...
        parameters=[{
            ...
            #   /cmd_vel
            #
            # D6 雷达相对车头后移约 15cm，之前稳定版就是保留安全层补偿。
